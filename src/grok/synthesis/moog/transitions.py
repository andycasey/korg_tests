...
_moog_amu = [1.008,4.003,6.941,9.012,10.81,12.01,14.01,16.00,19.00,20.18,
...
def write_moog(transitions, path, include_header=True):
    ...
    with open(path, "w") as f:
        ...
        for line in sorted(transitions, key=lambda l: l.lambda_air):
            ...
            D0 = f"{line.E_dissociation.to('eV').value:10.3f}" if line.E_dissociation is not None else space
